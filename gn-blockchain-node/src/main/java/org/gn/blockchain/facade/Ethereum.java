...
public interface Ethereum {
     ...
     * and decoded with {@link org.gn.blockchain.core.CallTransaction.Function#decodeResult(byte[])}.
     */
...
//  2.   // is blockchain still loading - if buffer is not empty
     ...
     * want to get accurate recommended gas price use {@link org.gn.blockchain.vm.listener.RecommendedGasPriceTracker}
     ...
     * @return Future, which completes when syncDone is turned to True in {@link org.gn.blockchain.vm.sync.SyncManager}
     */
